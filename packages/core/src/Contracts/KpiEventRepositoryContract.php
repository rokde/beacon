...
interface KpiEventRepositoryContract
{
     ...
     */
    public function insert(KpiKey $kpiKey, int|float $value, DateTimeImmutable $recordedAt, array $meta = []): void;
     ...
     */
    public function unprocessedSince(KpiKey $kpiKey, DateTimeImmutable $since): array;

    /**
     * Delete events older than the given datetime for a KPI.
     */
    public function deleteOlderThan(KpiKey $kpiKey, DateTimeImmutable $before): int;
}
